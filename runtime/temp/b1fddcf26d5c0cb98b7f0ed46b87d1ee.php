<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:83:"/Users/modou/Works/web/newlc/public/../application/backend/view/news/cateindex.html";i:1533524129;s:82:"/Users/modou/Works/web/newlc/public/../application/backend/view/public/header.html";i:1534318478;s:82:"/Users/modou/Works/web/newlc/public/../application/backend/view/public/footer.html";i:1533524129;}*/ ?>
<!DOCTYPE html>
<html>
<head>
  <meta charset="utf-8">
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="layui-btn-group">
                                <button class="layui-btn layui-btn-sm"  onclick="add_data('编辑分类',<?php echo $vo['id']; ?>)"><i class="layui-icon">&#xe642;</i>编辑</button>
...
<script type="text/javascript">
    function add_data(title,id){
        var url = "<?php echo url('News/cateAdd'); ?>"+ '?id=' + id;
        x_admin_show(title,url,500,500);
    }
    function del(id){
        layer.confirm('确认要删除吗？',function(index){
            var url = "<?php echo url('News/cateDelete'); ?>";
