<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:79:"/Users/modou/Works/web/newlc/public/../application/backend/view/news/index.html";i:1535014371;s:82:"/Users/modou/Works/web/newlc/public/../application/backend/view/public/header.html";i:1534318478;}*/ ?>
<!DOCTYPE html>
<html>
<head>
  <meta charset="utf-8">
...
<div class="layui-fluid">
          ...
          <div class="layui-inline">
            ...
            <div class="layui-input-block">
              <select name="status" id="selectstatus">
                <option value="">全部</option>
                <?php  if(isset($data['news_status'])){  foreach($data['news_status'] as $k=>$v): ?>
  ...
  <script>
    layui.use('table', function(){
        ...
        table.render({
            elem: '#layui-table'
            ,url: "<?php echo Url('news/getData'); ?>" //数据接口
            // ,width: 892
            //,height: 500
        ...
        form.on('switch(statusControl)', function(obj){
            ...
            var value = obj.value;
            var url = "<?php echo Url('news/changStatus'); ?>";
            var data = {id: id};
        ...
        table.on('tool(layui-table-tool)', function(obj){
            ...
            if(obj.event === 'edit'){
                var id = obj.data.id
                var url = "<?php echo Url('news/add'); ?>" + '?id=' + id;
                ...
                var id = obj.data.id
                var url = "<?php echo Url('news/tuji'); ?>" + '?id=' + id;
                location.href=url;
            }else if(obj.event === 'see'){
                var id = obj.data.id
                var url = "<?php echo Url('web/index/details'); ?>" + '?id=' + id;
                window.open(url);
            }
