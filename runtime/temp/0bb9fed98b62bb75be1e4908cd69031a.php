<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:79:"/Users/modou/Works/web/newlc/public/../application/backend/view/more/email.html";i:1534136137;s:82:"/Users/modou/Works/web/newlc/public/../application/backend/view/public/header.html";i:1534318478;}*/ ?>
<!DOCTYPE html>
<html>
<head>
  <meta charset="utf-8">
...
<form class="layui-form"  style="margin:100px 300px;" id="addform" >
    ...
    <div class="layui-form-item">
      <label class="layui-form-label">
        邮件标题<span style="color:red;">*</span>
      </label>
      <div class="layui-input-block">
        <input type="text"  class="layui-input"    value="邮件留言主题(测试内容禁止修改！)" disabled>
      </div>
    </div>
    <div class="layui-form-item layui-form-text">
          <label class="layui-form-label">邮件内容</label>
          <div class="layui-input-block">
              <textarea  placeholder="请输入内容" class="layui-textarea" disabled>欢迎使用邮件留言，祝您生活工作愉快！(测试内容禁止修改！)</textarea>
          </div>
      </div>
...
layui.config({
    ...
    form.on('submit(addaction)', function(data){
      var url = "<?php echo url('More/email'); ?>";
