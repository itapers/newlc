<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:87:"/Users/modou/Works/web/newlc/public/../application/backend/view/customer/cateindex.html";i:1535012097;s:82:"/Users/modou/Works/web/newlc/public/../application/backend/view/public/header.html";i:1534318478;s:82:"/Users/modou/Works/web/newlc/public/../application/backend/view/public/footer.html";i:1533524129;}*/ ?>
<!DOCTYPE html>
<html>
<head>
  <meta charset="utf-8">
      ...
      <div class="layui-col-md12">
        <div class="layui-card">
            <div class="layui-card-header">
                    客户分类列表
                <a href="javascript:;"  class="layui-btn layui-btn-sm layui-btn-normal" onclick="add_data('添加客户分类',0)" style="float:right;margin-top: 10px;">+添加客户分类</a>
            </div>
                ...
                <table class="layui-table">
                  ...
                  <tbody>
                    ...
                    <tr>
                        ...
                        <td><div style="width:50px;height:15px;background: #<?php echo $vo['color']; ?>"></div></td>
                        <td><?php echo $vo->ord; ?></td>
                        <td><span class="<?php echo $vo['status']==1?'':'layui-bg-orange'; ?>  radius"><?php echo $vo['status']==1?'已启用' : '已禁用'; ?></span>
                        </td>
                        <td><?php echo !empty($vo->hasGroupone->group_name)?$vo->hasGroupone->group_name:''; ?></td>
                        <td><?php echo !empty($vo->hasAuone->real_name)?$vo->hasAuone->real_name:''; ?></td>
                        <td><?php echo $vo->ctime; ?></td>
                        <td>
                            <div class="layui-btn-group">
                                <button class="layui-btn layui-btn-sm"  onclick="add_data('编辑客户分类',<?php echo $vo['id']; ?>)"><i class="layui-icon">&#xe642;</i>编辑</button>
...
<script type="text/javascript">
    function add_data(title,id){
        var url = "<?php echo url('Customer/cateAdd'); ?>"+ '?id=' + id;
        x_admin_show(title,url,500,500);
    }
    function del(id){
        layer.confirm('确认要删除吗？',function(index){
            var url = "<?php echo url('Customer/cateDelete'); ?>";
